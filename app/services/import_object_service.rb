class ImportObjectService
  ...
  def process_student_work_metadata
    ...
    student_work = process_embargo(student_work)

    student_work.save(index: true)
  end
  ...
  def process_generic_work_metadata
    ...
    generic_work = process_embargo(generic_work)
    generic_work.save(index: true)
  end
  ...
  def process_etd_metadata
    ...
    etd = process_embargo(etd)
    etd.save(index: true)
  end

  def assign_common_metadata(work)
    work.admin_set_id =  Hyrax.config.default_admin_set.id.to_s
  ...
  def process_embargo(work)
    return work unless metadata["embargo_release_date_dtsi"]
